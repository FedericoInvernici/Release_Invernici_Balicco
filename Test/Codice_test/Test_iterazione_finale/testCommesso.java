...
class testCommesso {
	...
	void testVendita() {
		...
		assertEquals(0.0,cm.vendita("Prova0",false),"Prova0 non è disponibile usato");
	...
	void testVerificaDisponibilità() {
		...
		assertTrue(cm.verificaDisponibilita("Prova0", true),"Il gioco Prova0 nuovo è disponibile in almeno una copia");
		assertFalse(cm.verificaDisponibilita("Prova0", false),"Il gioco Prova0 usato non è disponibile");
		assertFalse(cm.verificaDisponibilita("Prova400", true),"Il gioco Prova400 non è disponibile in quanto non è nel database");
	}
	@Test
	void testVerificaDisponibilitàPreo() {
		...
		assertFalse(cm.verificaDisponibilitaPreo("Prova0"),"Il gioco Prova0 non ha nessuna disponibilità per la prenotazione");
		assertTrue(cm.verificaDisponibilitaPreo("Prova7"),"Il gioco Prova7 è disponibile per essere prenotato");
		assertFalse(cm.verificaDisponibilitaPreo("Prova400"),"Il gioco Prova400 non è disponibile in quanto non è nel database");
	}
